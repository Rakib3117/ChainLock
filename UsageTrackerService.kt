...
class UsageTrackerService : Service() {
    ...
    private val INTERVAL_MS = 30_000L // check every 30 seconds
    ...
    private fun updateUsageProgress() {
        ...
        // Check if any new steps should be unlocked
    ...
    private fun checkAndUnlockSteps(progress: Map<String, Long>) {
        ...
        for (chain in chains) {
            ...
            // Check if current unlocked step's time is complete → unlock next
